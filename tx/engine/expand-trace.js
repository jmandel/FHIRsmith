/**
 * Expand Trace — ambient structured tracing for the IR expansion engine.
 *
 * Uses AsyncLocalStorage so any code in the expansion call chain can write
 ...
 *
 * When no trace is active (called outside traceStore.run), all calls are no-ops.
 */
